...
-- Q4. We would like to throw a promotional Music Festival in the city where we made the most money. Write a query that returns the city that has the highest sum of invoice totals.
...
-- Q6. Write a query to return the first name, last name, & email of all Rock Music listeners. Return your list ordered alphabetically by email starting with A.
...
-- Q12. Who is the most popular artists? We determine the most popular artists as the artists with the highest amount of purchases.
...
-- Q13. Which is the most popular song? We determine the most popular song as the song with the highest amount of purchases.
